...
const SidebarPage = () => {
  ...
  return (
    <>
      ...
      <p>Hi, I’m Gonçalo, a passionate Web Developer with 3 years of hands-on experience, I deliver innovative solutions for high-profile clients in multiple sectors. </p>
